...
class ScheduleTripScaffold extends GetView<ScheduleTripController> {
  const ScheduleTripScaffold({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar(colorScheme, media, title: "Schedule a trip"),
      body: ListView(
        ...
        children: [
          ...
          defaultInfoContainer(
            ...
            child: scheduleTripSelectDateTimeRouteForm(
