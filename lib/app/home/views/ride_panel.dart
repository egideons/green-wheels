...
class RidePanel extends GetView<HomeScreenController> {
  const RidePanel({super.key});
  ...
  rideSection(Size media, ColorScheme colorScheme) {
    return Column(
      ...
      children: [
        ...
        Obx(() {
          return Text(
            controller.rideInfoMessage.value,
